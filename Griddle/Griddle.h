...
//! Project version number for Griddle.
FOUNDATION_EXPORT double GriddleVersionNumber;

//! Project version string for Griddle.
FOUNDATION_EXPORT const unsigned char GriddleVersionString[];
